...
namespace Store.Tests.Entities
{
    ...
    {
        private readonly Customer _customer = new Customer("Nome customer", "customer@email.com");
        ...
        [TestMethod]
        [TestCategory("Order")]
        public void Dado_um_paramento_de_pedido_seu_status_deve_ser_aguardando_entrega()
        {
            var order = new Order(_customer, 0, null);
